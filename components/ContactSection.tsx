        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div className="bg-white p-8 rounded-xl shadow-md border border-gray-200">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">datascience484@gmail.com</p>
                  {/* <p className="text-gray-600">support@magickubes.ai</p> */}
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-medium text-black">Visit Us</h4>
                  <p className="text-gray-600">Peeram cheruv</p>
                  <p className="text-gray-600">RR District, Hyderabad City</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="flex space-x-4">
                <a href="#" className="p-2 bg-gray-100 rounded-full text-gray-700 hover:bg-gray-200 transition-colors">
          ...
          <div className="bg-white p-8 rounded-xl shadow-md border border-gray-200">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full bg-black text-white font-medium py-3 px-6 rounded-lg hover:bg-gray-800 transition-colors flex items-center justify-center"
              >
